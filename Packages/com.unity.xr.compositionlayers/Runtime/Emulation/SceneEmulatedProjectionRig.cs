...
namespace Unity.XR.CompositionLayers.Emulation
{
    ...
    internal class SceneEmulatedProjectionRig : MonoBehaviour
    {
        ...
        {
            DisposeAllSceneViewProjectors();
        }

        /// <summary>
        /// Disposes of all SceneViewProjectors
        /// </summary>
        internal static void DisposeAllSceneViewProjectors()
        {
        ...
        /// <summary>
        /// Build processor to ensure emulation resources are disposed before build.
        /// </summary>
        class SceneEmulatedProjectionRigBuildProcessor : IPreprocessBuildWithReport
        {
